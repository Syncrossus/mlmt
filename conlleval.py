# https://github.com/spyysalo/conlleval.py/blob/master/conlleval.py
...
def metrics(counts):
    ...
    by_type = {}
    uniq_keys = list(c.t_found_correct.keys()) + list(c.t_found_guessed.keys())
    for t in set(uniq_keys):
